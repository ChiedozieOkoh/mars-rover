...
/*	
	...
	public void shouldMakeMarsRover(){
		try {
			assertRoverRotation(1,1,Orientation.E,"1 1 N",new CommandList("R"));
			assertRoverRotation(1,1,Orientation.W,"1 1 N",new CommandList("L"));
			assertRoverRotation(1,1,Orientation.S,"1 1 E",new CommandList("R"));
			assertRoverRotation(1,1,Orientation.N,"1 1 W",new CommandList("R"));
	...
	private void assertRoverRotation(int x, int y, Orientation orientation, String origin, CommandList move){
	...
	private void assertRoverMove(int x, int y, Orientation orientation, String origin,String moves){
		try {
			Rover r =  new Rover(origin,TEST_PLATEAU_X,TEST_PLATEAU_Y);
			CommandList cmd = new CommandList(moves);
			cmd.run(r);
			r.display();
			assertTrue(r.equals(x,y,orientation));
		} catch (UnkownCommandException e) {
